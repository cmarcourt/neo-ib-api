...
public final class StringIdUtils {
     ...
     */
    public static String uniqueRandomId() {
     ...
     */
    public static String uniqueIdFromContract(final Contract contract) {
     ...
     */
    public static String uniqueIdFromExecutionReportFilter(final ExecutionReportFilter filter) {
        final StringBuilder builder = new StringBuilder();
    ...
    /**
     * String id based on {@link Order} and {@link Contract} properties concatenation
     */
    public static String uniqueIdFromOrderAndContract(final Order order, final Contract contract) {
        final StringBuilder builder = new StringBuilder("@");
