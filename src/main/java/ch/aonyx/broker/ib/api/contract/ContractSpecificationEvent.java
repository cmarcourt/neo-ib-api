 ...
 * @since 1.0.0
 */
public final class ContractSpecificationEvent extends AbstractEventSupport {

	private final ContractSpecification contractSpecification;

	public ContractSpecificationEvent(final Id requestId, final ContractSpecification contractSpecification) {
		super(requestId);
	...
	public Class<?> getAssignableListenerType() {
		return ContractSpecificationEventListener.class;
	}
