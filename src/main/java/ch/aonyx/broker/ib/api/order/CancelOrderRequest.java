 ...
 * @since 1.0.0
 */
public final class CancelOrderRequest extends AbstractOrderRequestSupport implements OrderRequest {

	private static final int VERSION = 1;

	public CancelOrderRequest(final String orderId) {
		super(orderId);
	}

	public CancelOrderRequest(final OrderId orderId) {
		super(orderId);
	}
