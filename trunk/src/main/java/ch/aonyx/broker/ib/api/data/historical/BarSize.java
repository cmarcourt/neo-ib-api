...
public enum BarSize {
	...
	ONE_SECOND(1, SECOND), FIVE_SECONDS(5, SECONDS), FIFTEEN(15, SECONDS), THIRTY(30, SECONDS), ONE_MINUTE(1, MINUTE), TWO_MINUTES(
			2, MINUTES), THREE_MINUTES(3, MINUTES), FIVE_MINUTES(5, MINUTES), FIFTEEN_MINUTES(15, MINUTES), THIRTY_MINUTES(
			30, MINUTES), ONE_HOUR(1, HOUR), ONE_DAY(1, DAY);
