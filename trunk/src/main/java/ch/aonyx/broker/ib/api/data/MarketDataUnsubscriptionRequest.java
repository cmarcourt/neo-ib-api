 ...
 * @version 1.0.0
 */
public final class MarketDataUnsubscriptionRequest extends AbstractRequestSupport implements UnsubscriptionRequest {

	private static final int VERSION = 1;

	public MarketDataUnsubscriptionRequest(final String id) {
		super(id);
	}

	public MarketDataUnsubscriptionRequest(final RequestId requestId) {
		super(requestId);
	}
