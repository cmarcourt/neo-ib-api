 ...
 * @since 1.0.0
 */
public final class MarketScannerValidParametersRequest extends AbstractRequestSupport implements SimpleRequest {

    private static final int VERSION = 1;

    protected MarketScannerValidParametersRequest() {
