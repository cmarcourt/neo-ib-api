 ...
 * @since 1.0.0
 */
public final class MarketScannerUnsubscriptionRequest extends AbstractRequestSupport implements UnsubscriptionRequest {

    private static final int VERSION = 1;

    public MarketScannerUnsubscriptionRequest(final String id) {
        super(id);
    }

    public MarketScannerUnsubscriptionRequest(final RequestId id) {
        super(id);
    }
