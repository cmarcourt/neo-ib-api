...
public enum OcaType {
	...
	UNKNOWN(-1), CANCEL_REMAINING_ORDERS_WITH_BLOCK(1), PROPORTIONATELY_REDUCE_REMAINING_SIZE_ORDERS_WITH_BLOCK(2), PROPORTIONATELY_REDUCE_REMAINING_SIZE_ORDERS_WITH_NO_BLOCK(
			3), EMPTY(0);
