...
public enum ReturnedTickTypeFilter {
	...
	UNKNOWN(-1), OPTION_VOLUME(100), OPTION_OPEN_INTEREST(101), HISTORICAL_VOLATILITY(104), OPTION_IMPLIED_VOLATILITY(
			106), INDEX_FUTURE_PREMIUM(162), MISCELLANEOUS_STATS(165), MARK_PRICE(221), AUCTION_VALUES(225), REAL_TIME_VOLUME(
			233), SHORTABLE(236), INVENTORY(256), FUNDAMENTAL_RATIOS(258), REAL_TIME_HISTORICAL_VOLATILITY(411);
